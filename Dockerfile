...
MAINTAINER "Hammad Ahmed" <hammadahmedkhan89@gmail.com>
...
# RUN apt-get install -y gcc phantomjs firefox
...
ENTRYPOINT ["/bin/bash", "/suite/execution/scripts/asyc_run.sh"]
CMD ["/execution/scripts/start_script.sh"]
